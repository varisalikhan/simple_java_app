                ...
                container('snyk') {
                    script {
                        catchError(buildResult: 'UNSTABLE', stageResult: 'FAILURE') {
                            ...
                            sh 'snyk monitor --file=docker-archive:/var/lib/containers/java-application2_local.tar --org=b250d181-3d61-47e9-8bfb-aa1375a534cc --json --debug > snyk_scan_results.json'
                        }
